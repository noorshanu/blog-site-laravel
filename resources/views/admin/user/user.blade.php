                  ...
                  <div class="card-body">
                      <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tittle"  name="tittle" placeholder="Enter post tittle">
                          </div>
                          <div class="form-group">
                              <label for="subtittle">Sub Tittle</label>
                              <input type="text" class="form-control" id="subtittle"  name="subtittle" placeholder="Enter post sub tittle">
                            </div>
                            <div class="form-group">
