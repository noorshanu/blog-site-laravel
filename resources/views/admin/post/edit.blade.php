            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Post Editors</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tittle" name="tittle"
                                        placeholder="Enter post tittle"value="{{$post->tittle}}">
                                </div>
                                <div class="form-group">
                                    <label for="subtittle">Sub Tittle</label>
                                    <input type="text" class="form-control" id="subtittle" name="subtittle"
                                        placeholder="Enter post sub tittle" value="{{$post->subtittle}}">
                                </div>
                                <div class="form-group">
                                    <label for="slug">Post Slug</label>
                                    <input type="text" class="form-control" id="slug" name="slug"
                                        placeholder="Enter post slug" value="{{$post->slug}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="status" @if ($post->status == 1) checked @endif>
